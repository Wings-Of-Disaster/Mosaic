...
class ClientTrainer:
    ...
    def degan(self, step):
        ...
        if self.data_set == 'CIFAR-10':
            ...
            classifier = ResNet18(num_classes=100)
        else:
            raise ValueError(f"Unsupported dataset: {self.data_set}")
        ...
        if step == 0:
            ...
            device=self.device, netD=netD, netG=netG, classifier=classifier, optimizerD=optimizerD, optimizerG=optimizerG,
